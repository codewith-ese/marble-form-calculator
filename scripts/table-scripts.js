...
document.getElementById("tableForm").addEventListener("submit", function(event) {
    ...
    document.getElementById("tableTop").innerHTML = "Table Top ➡️ : " + tableLength + " x " + tableWidth + " cm (Area: " + tableTopArea + " cm²)";
    document.getElementById("tableLegs").innerHTML = "Table Legs ➡️ : " + tableHeight + " X " + " 9 cm (8 Pieces)";
    document.getElementById("tableConnL").innerHTML = "Long Connection ➡️ : " + roundConnLenght + " x " + " 9 " + " cm (2 Pieces)";
    document.getElementById("tableConnS").innerHTML = "Short Connection ➡️ : " + roundConnWidth + " x " + " 9 " + " cm (2 Pieces)";
